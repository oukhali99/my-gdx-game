...
public class Attack extends BaseGameObject {
    ...
    public Attack(Drop game, final Ability ability, GameObject attacker, final GameObject target, CombatScreen.Fight fight) {
        super(game);
        ...
        final GameObject thisBaseGameObject = this;
            ...
            public CollisionRunnable getOnCollisionRunnable() {
                return new CollisionRunnable() {
                    ...
                    public void run(GameObject otherGameObject) {
                        if (otherGameObject.equals(target)) {
